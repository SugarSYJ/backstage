<template>
    <div>
        ...
        <div class="dk-datagrid-content">
                ...
                <thead>
                    <tr>
                        ...
                        <th v-if="config.multiple">
                            <input type="checkbox" :checked="selecteds.length == (this.config.datasource || datasource ).length" @click="trEvent('*')">
                        </th>
            ...
            <navigation v-if="config.pagination" :pages="pages" :current.sync="page" @navpage="pageList"></navigation>
        </div>
    </div>
</template>
	...
	export default {
        ...
        methods: {
            ...
            trEvent(item, event){
                //全选
                if(item == '*'){
                    if(this.selecteds.length == this.datasource.length){
                        this.selecteds = [];
                    } else {
